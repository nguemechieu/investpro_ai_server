...
# # Step 1: Generate (or load) historical candles
...
# # Step 2: Feature Engineering (EMA, RSI, MACD)
# def add_features(df):
...
#     df['label'] = np.where(df['future_close'] > df['close'], 1, 0)  # 1 = BUY, 0 = SELL
#     return df.dropna()
...
#     feature_cols = ['close', 'open', 'high', 'low', 'volume', 'body_size', 'range', 'ema_12', 'ema_26', 'rsi', 'macd']
#     X = df[feature_cols]
#     y = df['label']
...
#     model.save("investpro_ai_dnn_model.h5")
#     print("✅ DNN model saved as investpro_ai_dnn_model.h5")

#     # Save the scaler too!
#     import joblib
#     joblib.dump(scaler, "investpro_scaler.pkl")
#     print("✅ Scaler saved as investpro_scaler.pkl")
